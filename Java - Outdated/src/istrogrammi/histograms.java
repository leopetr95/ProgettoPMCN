...
class Cdh {
  ...
  public static void main(String[] args) throws IOException {
    ...
    String line = null;
    //TODO inserire la stringe per andare a determinare il file CSV sul quale andare ad eseguire l'istogramma.
    String path = null; //Da modificare successivamente.
    BufferedReader in = null; //Da modificare succeessivamente
    //-------------------
